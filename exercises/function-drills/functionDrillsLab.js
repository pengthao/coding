...
//CODE HERE
const jsNinja = () => console.log('I am JavaScript ninja!')
...
console.log('exclaimtwo2')
console.log(exclaimTwo2('hello'))
...
const nameGreeting = nameCheck('Peng')
...
const theEliminator = (contestants, loser) => {
  const index = contestants.indexOf(loser, 1);
  if(index !== -1) {
...
const starGreeting = (inputString) => console.log(inputString.toUpperCase())

const greetings = starGreeting(sampleString);
...
const email1 = emailCheck('peng.thao@devmountain.com')
const email2 = emailCheck('peng.thao.devmountain.com')
...
const chocolateFrogs = (goldToSpend) => {
  const frogPrice = 3
  const totalFrogs = Math.floor(goldToSpend/frogPrice)
  return totalFrogs;
}

const totalFrogs = chocolateFrogs(16)
...
////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,4,7,5,6,4,9]
/*
...
const arrayIsAscending = console.log(arrAsc(sampleArray))
