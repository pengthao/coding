...
//Code Here
// used a method shown from a previous question. stored case results into grade variable. not really necessary
var grade;

switch (true) {
  case letterGrade === 'A': 
    grade = "The student is doing excellently.";
    break;
  case letterGrade === 'B': 
    grade = "The student is doing well.";
    break;
  case letterGrade === 'C': 
    grade = "The student is doing alright.";
    break;
  case letterGrade === 'D': 
    grade = "The student is not doing very well.";
    break; 
    default:
    grade = "The student is failing.";    
}
console.log(grade);
