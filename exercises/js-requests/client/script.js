...
// PROBLEM 1
/*
    In the index.html file in this folder there is 
    a button with an id of 'say-hello-button'!

    Use querySelector to select that button 
    and save it to a variable called sayHelloButton
*/
...
/*
    Create a function that changes sayHelloButton's
     background color to black and its text color to white 
     (you can use the .style object or create a CSS class
     and use classList.add)
    
    Attach a mouseover event to sayHelloButton that calls
     the function you wrote
*/

// CODE HERE

function shbStyling(e) {
    e.target.classList.add("helloButton")
    console.log(e.target.classList)
}
function removeShbStyling(e) {
    e.target.classList.remove('helloButton')
//    console.log(e.target.classList)
}


sayHelloButton.addEventListener('mouseenter', shbStyling)
sayHelloButton.addEventListener('mouseleave', removeShbStyling)
//console.log(document.querySelector('#say-hello-button'))
...
/*
    ...
    Handle the promise that's returned with a .then, which you should pass a callback
     function to. Inside the callback function, console.log the response's 
