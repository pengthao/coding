...
if(amysBirthYear===brittanisBirthYear){
  console.log("They have the same birthday!")
}
else{
  console.log("They don't have the same birthday.")
}
...
if (rain){
  ...
  else if(80>=temperature>=60){
    console.log("You should wear a rain-jacket.")
  }
  if(temperature<=60){
    console.log("Its getting cold and wet out")
  }
} else {
  if(temperature>=80){
    console.log("A T-shirt is all you need")
  }
  else if(80>=temperature>=60){
    console.log("Maybe a light jacket.")
  }
 else if(temperature<=60){
    console.log("Its getting cold out there")
  }
}
